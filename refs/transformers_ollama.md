...
3. Registrar dependencias utilizadas en el entorno virtual (opcional)

```bash
python -m pip freeze > requirements.txt
```

*Nota*. Una alternativa bastante útil para entornos virtuales es [Pipenv](https://pipenv.pypa.io/en/latest/), pero la recomiendo más para ejecutar códigos desde la consola y no notebooks.
